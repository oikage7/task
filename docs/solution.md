...
**Участник / команда:** Гладышев Вячеслав 
...
_Заполнение:_
Для обеспечения кибериммунитета в АБУ. Критические операции были помещены в модуле abu.tcb,
а недоверенная зона была помещена в abu.other
